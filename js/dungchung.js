...
function themVaoGioHang(masp, tensp) {
  ...
  if (currentProduct.qty == 0) {
    addAlertBox(
      "Sản phẩm " + tensp + " đang tạm hết. Vui lòng quay lại sau!",
      "#17c671",
      "#fff",
      3500
    );
	...
	<div class="top-nav group">
        <section>
            ...
            <ul class="top-nav-quicklink flexContain">
                ...
                <li><a href="lienhe.html"><i class="fa fa-id-card"></i> Liên hệ</a></li>
            </ul> <!-- End Quick link -->
        </section><!-- End Section -->
    </div><!-- End Top Nav  -->`);
}
...
function addHeader() {
  document.write(`        
	<div class="header group">
        <div class="logo">
            <a href="index.html">
                <img src="img/logo.png" alt="Trang chủ Nhóm 19" title="Trang chủ Nhóm 19">
            </a>
        </div> <!-- End Logo -->
            ...
            <div class="search-header" style="position: relative; left: 50px; top: 1px;">
                <form class="input-search" method="get" action="index.html">
                    <div class="autocomplete">
                        <input id="search-box" name="search" autocomplete="off" type="text" placeholder="Nhập hãng cần tìm">
                        <button type="submit">
...
function addFooter() {
  document.write(`
    ...
    <div class="copy-right">
        <p><a href="index.html">Nhom19_Web</a> -  © 3/6/2023 -  by
            <span style="color: #eee; font-weight: bold"><a href="lienhe.html" style= "cursor:pointer">Nhom19</a></span></p>
    </div>`);
}
            ...
            <div class="tab-content">
                ...
                <div id="signup">
                    ...
                    <form onsubmit="return signUp(this);">
                        ...
                        <button type="submit" class="button button-block" />Đăng kí tài khoản</button>
